...
def create_database():
    ...
    """
    conn = sqlite3.connect('library.db')  # Creates the database file.
    c = conn.cursor()
...
def add_book():
    ...
    try:
        ...
        # Retrieve existing book titles from the database
        ...
        # Check if any similar titles are found with a score greater than 80
